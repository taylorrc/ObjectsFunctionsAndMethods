...
def turtle4():
    ...
    stephen.Pen = rg.Pen("green", 5)

    stephen.right(180)
    stephen.forward(200)
    stephen.left(45)
    stephen.draw_circle(50)


def turtle5():
    grant = rg.SimpleTurtle('turtle')
    grant.Pen = rg.Pen("khaki", 7)

    grant.forward(100)
    grant.draw_circle(75)

    andrew = rg.SimpleTurtle('arrow')
    andrew.Pen = rg.Pen('gray58', 7)

    andrew.backward(100)
    andrew.draw_square(75)
