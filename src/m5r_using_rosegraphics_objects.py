...
#                fill, fill_color, outline_color
#
#     f. What does a RoseWindow RENDER method do?
#                Draws all of the object that are in the window, as seen on line 152
#
#     g. When is a RoseWindow close_on_mouse_click method call necessary?  Why?
#            Every time after opening a window, a close_on_mouse_click is necessary. This will make sure that the
#            window will not close immediately after being opened and will only close when the user is ready.
#
